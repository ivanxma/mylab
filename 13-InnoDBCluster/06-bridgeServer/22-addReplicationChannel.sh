...
#    SOURCE_RETRY_COUNT & SOURCE_CONNECT_RETRY : define the failover time. The default setting is… 60 days, probably not what you want :). So, you (most likely) should reduced the settings. e.g. 1 minute is respectively 20 and 3. (20 x 3 = 60)
#     FOR CHANNEL : enables you to name which replication channel the statement applies to. The CHANGE REPLICATION SOURCE TO statement applies to this specific replication channel.
