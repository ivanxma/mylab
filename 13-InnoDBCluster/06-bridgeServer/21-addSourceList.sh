...
sess3316.runSql("SELECT asynchronous_connection_failover_add_managed('$BRIDGE_CHANNEL', 'GroupReplication', '" + gname + "', '$CLUSTER_HOST', 3310, '', 60, 80); ")

EOL


sleep 10
./25-show_failover_connection.sh
