...
mysql -uroot -h127.0.0.1 -P3340 -e "change master to master_user='rpl_user', master_password='rpl_pass' for channel 'group_replication_recovery';"
...
mysql -uroot -h127.0.0.1 -P3350 -e "change master to master_user='rpl_user', master_password='rpl_pass' for channel 'group_replication_recovery';"
...
mysql -uroot -h127.0.0.1 -P3360 -e "change master to master_user='rpl_user', master_password='rpl_pass' for channel 'group_replication_recovery';"
