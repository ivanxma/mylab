NDBFOLDER=/usr/local/mysql-cluster-commercial-8.0.26-linux-glibc2.12-x86_64
NDBLINK=/home/mysql/mcm/cluster-latest
NDBTAR=/workshop/linux/ndb/mysql-cluster-commercial-8.0.26-linux-glibc2.12-x86_64.tar.gz
