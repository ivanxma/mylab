NDBFOLDER=/opt/mysql-cluster-commercial-8.0.31-linux-glibc2.12-x86_64
NDBLINK=/home/mysql/mcm/cluster-latest
NDBTAR=/opt/download/mysql/ndb/mysql-cluster-commercial-8.0.31-linux-glibc2.12-x86_64.tar.gz
