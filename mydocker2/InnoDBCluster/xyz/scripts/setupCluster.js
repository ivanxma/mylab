...
try {
  dba.configureInstance('root@mysql-server-1:3306', {password:dbPass});
  dba.configureInstance('root@mysql-server-2:3306', {password:dbPass});
  dba.configureInstance('root@mysql-server-3:3306', {password:dbPass});
